...
import { DocumentAggregate, DocumentAggregateProps } from "@/app/aggregates/base.aggregate";
import { DateType } from "@/app/types/date.type";
import { MapType } from "@/app/types/map.type";
import { ReferenceString } from "@/app/types/ref-string.type";
import firestoreDb from "@/firebase/firebase-config";
import { RoomMemberMetadata, UserEntity } from "@/user/aggregates/user.aggregate";
